...
'''author@esilgard'''
#
# Copyright (c) 2017-2018 Fred Hutchinson Cancer Research Center
#
...
def get(abnormality_dictionary, abnormality_set, offsets, karyotype_string, karyo_offset):
    '''
    Assign ELN risk categories based on important standard cytogenetic abnormalities
    '''
   
    eln_dictionary = {gb.NAME:gb.ELN, gb.VALUE:gb.INTERMEDIATE, gb.VERSION:__version__, 'Rationale' : []}
    ...
    if not classification_found:
        if abnormality_dictionary.get(gb.ABNS,0):
